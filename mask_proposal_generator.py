...
from visual_prompting import visual_prompting
...
def mask_proposal_generator(model, cam, bg_text_features, image_path, label_list, output_path="resources/output", save=False, eta=0.5):
    ...
    mask_save_dir = f"{output_path}/mask/"
    ...
    for index, label in enumerate(label_list):
        ...
        visual_prompt = visual_prompting(image_path=image_path, cam_dic=cam_dic, threshold=eta, output_path=visual_prompt_save_path, save=save, method='blur')
